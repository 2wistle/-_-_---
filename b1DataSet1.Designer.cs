...
namespace ppsat {
    ...
    public partial class b1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class СтатусDataTable : global::System.Data.TypedTableBase<СтатусRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public СтатусRow AddСтатусRow(int ID, string Статус) {
...
namespace ppsat.b1DataSet1TableAdapters {
    ...
    public partial class СтатусTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Статус] WHERE (([ID] = @Original_ID) AND ((@IsNull_Статус = 1 " +
                "AND [Статус] IS NULL) OR ([Статус] = @Original_Статус)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Статус] ([ID], [Статус]) VALUES (@ID, @Статус);\r\nSELECT ID, Ст" +
                "атус FROM Статус WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Статус] SET [ID] = @ID, [Статус] = @Статус WHERE (([ID] = @Original" +
                "_ID) AND ((@IsNull_Статус = 1 AND [Статус] IS NULL) OR ([Статус] = @Original_Ста" +
                "тус)));\r\nSELECT ID, Статус FROM Статус WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Статус FROM dbo.Статус";
        ...
        public virtual int Fill(b1DataSet1.СтатусDataTable dataTable) {
        ...
        public virtual b1DataSet1.СтатусDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            b1DataSet1.СтатусDataTable dataTable = new b1DataSet1.СтатусDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(b1DataSet1.СтатусDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Статус) {
        ...
        public virtual int Insert(int ID, string Статус) {
        ...
        public virtual int Update(int ID, string Статус, int Original_ID, string Original_Статус) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Статус, int Original_ID, string Original_Статус) {
            return this.Update(Original_ID, Статус, Original_ID, Original_Статус);
        }
    }
